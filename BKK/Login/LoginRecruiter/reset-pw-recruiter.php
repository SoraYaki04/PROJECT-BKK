...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        // Update password
        $update_sql = "UPDATE users SET password = ? WHERE username = ? AND role = 'recruiter'";
    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <form method="POST" action="">
                ...
                <button type="button" class="lewati-button" onclick="window.location.href='recruiter-login.php'">LEWATI</button>
            </form>
