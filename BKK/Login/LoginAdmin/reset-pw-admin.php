...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username) || empty($old_password) || empty($new_password) || empty($confirm_password)) {
        ...
        header("Location: reset-pw-admin.php");
        exit();
    }
    ...
    // TODO Ambil data admin dari tabel `users` dengan role = 'admin'
        ...
        <div class="login-card">
            ...
            <form method="POST" action="">
                ...
                <button type="button" class="lewati-button btn"
                    onclick="window.location.href='admin-login.php'">LEWATI</button>
            </form>
