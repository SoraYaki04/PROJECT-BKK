...
<body>
    ...
    <?php include __DIR__ . '/../partials/navbar/header.php' ?>
    ...
    <div class="container">
        ...
        <?php
        if (!is_logged_in()) {
            include __DIR__ . '/../partials/navbar/guest.php';
        } elseif (is_alumni()) {
            include __DIR__ . '/../partials/navbar/alumni.php';
        } elseif (is_admin()) {
            include __DIR__ . '/../partials/navbar/admin.php';
        }
        ?>
            ...
            <div style="background: #ffebee; border: 1px solid #f44336; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
                ...
                <div style="background: #f5f5f5; padding: 15px; border-radius: 5px;">
                    ...
                    <ol style="color: #555;">
                        ...
                        <li>Run the database setup: <a href="../tools/setup_database.php" style="color: #1976d2;">setup_database.php</a></li>
                    </ol>
                </div>
            </div>
            <?php else: ?>
