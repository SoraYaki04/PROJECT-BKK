...
if (isset($_POST['add'])) {
    ...
    if (  !$judul_lowker || !$deskripsi_lowker || !$id_perusahaan || !$id_jurusan) {
        header("Location: crud.php?msg=" . urlencode("Semua field wajib diisi!"));
        exit;
    }
    ...
    header("Location: crud.php?msg=" . urlencode("Lowker berhasil ditambahkan!"));
    exit;
}
...
if (isset($_GET['delete'])) {
    ...
    header("Location: crud.php?msg=" . urlencode("Lowker berhasil dihapus."));
    exit;
}
...
if (isset($_POST['update'])) {
    ...
    header("Location: crud.php?msg=" . urlencode("Data berhasil diupdate!"));
    exit;
}
...
// Fetch all lowker data with company names
