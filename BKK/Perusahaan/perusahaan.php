      ...
      <div class="company-list">
        <?php foreach ($data as $row): ?>
          ...
          <?php
            ...
            $gambarPath = __DIR__ . '/../uploads/perusahaan/' . $gambarFile;
            if ($gambarFile !== '' && file_exists($gambarPath)) {
              $imageUrl = base_url('uploads/perusahaan/' . $gambarFile);
            } else {
              $imageUrl = base_url('Perusahaan/perusahaan 1.png');
            }
          ?>
