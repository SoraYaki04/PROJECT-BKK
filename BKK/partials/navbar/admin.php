...
<nav class="navbar">
  <ul class="navbar-container">
    <li class="logout-left">
      <a href="<?= base_url('Login/logout.php') ?>" title="Logout" aria-label="Logout">
    ...
    <li><a class="<?= nav_active(['Loker/loker.php', 'Loker/detail-lowker.php', 'Loker/persyaratan.php']) ?>" href="<?= base_url('Loker/loker.php') ?>"> LOWONGAN KERJA </a></li>
    ...
    <li class="crud-dropdown">
      <a class="<?= nav_active(['CRUD/perusahaan/perusahaan.php', 'CRUD/loker/loker.php', 'CRUD/loker/loker-tambah.php', 'CRUD/loker/loker-edit.php', 'CRUD/informasikegiatanbkk/infokegbkk.php']) ?>" href="#">C.R.U.D<i class="fa-solid fa-chevron-down"></i></a>
      <ul class="dropdown">
        ...
        <li><a class="<?= nav_active(['CRUD/loker/loker.php', 'CRUD/loker/loker-tambah.php', 'CRUD/loker/loker-edit.php']) ?>" href="<?= base_url('CRUD/loker/loker.php') ?>">CRUD Lowongan Kerja</a></li>
      </ul>
    </li>
