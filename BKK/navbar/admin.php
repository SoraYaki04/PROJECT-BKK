...
<nav class="navbar">
  <ul class="navbar-container">
          <li>
        <div onclick="window.location.href='<?= base_url('Login/logout.php') ?>'" class="profile-icon">
    ...
    <li>
      ...
      <ul class="dropdown">
        ...
        <li><a href="<?= base_url('Login/loginrecruiter/recruiter-login.php') ?>">Partisipan Lain</a></li>
      </ul>
    </li>
    <?php endif; ?>
