...
<body>
    ...
    <div class="container">
        <nav class="navbar">
            ...
            <ul>
                <li><a href="../../../Profil/profil.php"> <img class="profil-pojok" src="profilsiswabkk.png"></a></li>
                <li>
                ...
                <li>
                    <a href="#">TENTANG KAMI<i class="fa-solid fa-chevron-down"></i></a>
                    <ul class="dropdown">
                        <li><a href="">Visi Misi</a></li>
                        <li><a href="">Program Kerja BKK</a></li>
