...
<head>
    ...
    <title>Info Kegiatan BKK</title>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;800&display=swap" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css" rel="stylesheet">
    <link href="info-keg.css?v=<?php echo time(); ?>" rel="stylesheet">
</head>
<body>
    <header>
        <div class="rectangle">
          ...
          <!-- data-feather="chevron-down"> -->
           <ul class="navbar-container">
            <li>
              ...
              <ul class="dropdown">
                <li><a href="../Halaman Utama/berandautama.html">Halaman Utama</a></li>
                <li><a href="../Pengantar/pengantar.html" class="active">Pengantar</a></li>
                <li><a href="../Informasi Kegiatan BKK/informasikegiatanbkk.html">Informasi Kegiatan BKK</a></li>
                <li><a href="../Rekapitulasi/rekapitulasi.html">Rekapitulasi</a></li>
              </ul>
            </li>
    ...
    <div class="card-container">
        <div class="card">
            <div class="title">KUNJUNGAN INDUSTRI</div>
            <div class="card-content">
                <div class="foto">
                    <img src="Kunjungan.jpeg" alt="Kunjungan Industri">
                </div>
                <div class="deskripsi">
                    <hr>
                    <p>Kegiatan rutin yang dilakukan oleh SMKN 1 Boyolangu untuk mengajak siswa mengunjungi perusahaan-perusahaan besar di sekitar wilayah Jawa Timur.</p>
